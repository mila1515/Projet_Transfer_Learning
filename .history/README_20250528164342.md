...
Ce projet vise à développer un système de classification automatique de pneumonie à partir de radiographies thoraciques (chest X_ray) en utilisant des techniques de Deep Learning.L’approche s’appuie sur le transfert de connaissances (transfer learning) et l’évaluation complète du modèle avec des métriques médicales pertinentes.
